<?php
class Inovarti_Relatorios_Block_Adminhtml_Sales_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addExportType('*/*/exportInovartiOrdersCsv', $helper->__('CSV'));
        $this->addExportType('*/*/exportInovartiOrdersExcel', $helper->__('Excel XML'));
